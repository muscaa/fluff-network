...
public class SimpleClientConnection extends AbstractClientConnection {
	...
	public SimpleClientConnection(AbstractServer server, UUID uuid, Socket socket, PacketContext<?> context, INetHandler handler) throws IOException, NetworkException {
		super(server);
